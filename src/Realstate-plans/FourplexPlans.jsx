                            ...
                            <div className="upgrade-table">
                                <div className="upgrade-table__repeater">
                                    <div className="upgrade-table__input">
                                        <input type="text" />
                                        <div className="upgrade-table__price">$160</div>
                                    ...
                                    <div className="upgrade-table__input">
                                        <input type="text" />
                                        <div className="upgrade-table__price">$340</div>
                                ...
                                <div className="upgrade-table__repeater">
                                    ...
                                    <div className="upgrade-table__input">
                                        ...
                                        <div className="upgrade-table__price">$400</div>
                                ...
                                <div className="upgrade-table__repeater">
                                    <div className="upgrade-table__input">
                                        <input type="checkbox" />
                                        <div className="upgrade-table__price">$600</div>
                                        <div className="upgrade-table__title">Casita</div>
                                    </div>
                                    <div className="upgrade-table__input">
                                        <input type="text" />
                                        <div className="upgrade-table__price">$620</div>
                                ...
                                <div className="upgrade-table__repeater">
                                    ...
                                    <div className="upgrade-table__input">
                                        <input type="text" />
                                        <div className="upgrade-table__price">$700</div>
                                        <div className="upgrade-table__title">Swimming Pool/Spa Equipment</div>
                                    </div>
                                    <div className="upgrade-table__input">
                                        <input type="text" />
                                        <div className="upgrade-table__price">$1400</div>
                                ...
                                <div className="upgrade-table__repeater">
                                    ...
                                    <div className="upgrade-table__input">
                                        <input type="text" />
                                        <div className="upgrade-table__price">$240</div>
