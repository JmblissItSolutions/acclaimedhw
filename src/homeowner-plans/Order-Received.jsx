...
const OrderReceived = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://replatform.acclaimedhw.com/replatform/api/getorder/${id}`)
                                                        ...
                                                        <tr className="cart_item" key={item.id}>
                                                            ...
                                                            <td className="product-total">
                                                                <span className="woocommerce-Price-amount amount">
                                                                    <bdi>
                                                                        <span className="woocommerce-Price-currencySymbol">$</span>{item.pay_interval_type == 'yearly' ? item.productinfo.yearly_price : item.productinfo.monthly_price}
                                                                    </bdi>
                                                                </span>
                                                            </td>
                                                        </tr>
