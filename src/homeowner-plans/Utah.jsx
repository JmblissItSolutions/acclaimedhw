...
import SingleFamily from "./UtahUnitSize/SingleFamily";
import Duplex from "./UtahUnitSize/Duplex";
import Triplex from "./UtahUnitSize/Triplex";
import Fourplex from "./UtahUnitSize/Fourplex";
import UtahHomeowner from  "./../assets/images/UtahHomeowner.png"
import { Helmet } from "react-helmet"; 
import {BrowserRouter as Router, useHistory,useLocation} from "react-router-dom";

const Utah = () =>{
  const [utahState, setUtahState] = useState("");
  ...
  return (
    <>
      <Helmet>
        <title>See Benefits and Resource Guides for Home Warranty Services in Utah</title>
        <meta name="description" content="Acclaimed Home Warranty has provided some of the useful resources for people in Utah looking out for home warranty plans. Contact us today for more." />
      </Helmet>
      <div className="home_page">
        ...
        <section className="change-location-header">
          <div className="container d-flex just-space">
            ...
            <div>
              <div>
                <span>Unit Size</span>
                <select name="size" className="" onChange={(e) => { const selectedd = e.target.value; setUtahState(selectedd); }}>
        ...
        {/* fix on top header while scroll */}
         ...
         <section className="light-back plan-options">
            {utahState === "0" ? <SingleFamily /> : utahState === "1" ? <Duplex />
              : utahState === "2" ? <Triplex /> : utahState === "3" ? <Fourplex /> : <SingleFamily />}
