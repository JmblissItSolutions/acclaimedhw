          ...
          <div className="container">
            <div className="table-cont">
              ...
              <div className="option-cont table-right">
                ...
                {/* end of option */}
                <div className="option">
                  <div className="star-cont"><i className="achi white-star"></i><i className="achi white-star"></i><i className="achi white-star"></i></div>
                  <div className="body">
                    <h6 className="upper">Premium +</h6>
                    <h4 className="lato">$50.00<span style={{fontSize:"0.4em"}}>/MO</span></h4>
                    <h5 className="lato">$500/YR</h5>
                    <a className="btn">Buy Now</a>
                  </div>
                </div>
                {/* end of option */}
                <div className="option">
                  <div className="star-cont"><i className="achi white-star"></i><i className="achi white-star"></i><i className="achi white-star"></i><i className="achi white-star"></i></div>
                  <div className="body">
                    <h6 className="upper">Premium + one</h6>
                    <h4 className="lato">$53.50<span style={{fontSize:"0.4em"}}>/MO</span></h4>
                    <h5 className="lato">$550/YR</h5>
                    <a className="btn">Buy Now</a>
                  </div>
                </div>
                {/* end of option */}
