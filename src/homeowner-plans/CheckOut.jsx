...
const CheckOut = () => {
    ...
    //const totalwithdiscount = total-couponamount
    ...
    function AppyCoupon() {
        ...
        fetch("https://replatform.acclaimedhw.com/replatform/api/applycoupon", {
            method: "POST",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
            ...
            .then((resp) => {
                resp.json().then((applyresult) => {
                    //console.warn("couponresult", applyresult)
                                    ...
                                    <div className="woocommerce-billing-fields">
                                        ...
                                        <div className="woocommerce-billing-fields__field-wrapper">
                                            ...
                                            <p className="form-row form-row-wide">
                                                ...
                                                <select value={state} maxLength="35" onChange={(e) => { setState(e.target.value) }}>
                                            ...
                                            <p className="form-row form-row-wide">
                                                ...
                                                <input type="number" maxLength="20" className="input-text" value={pincode} onChange={(e) => { setPincode(e.target.value) }}></input>
                                            </p>
                                            <p className="form-row form-row-wide">
                                ...
                                <div className="col-2">
                                    ...
                                    <div className="woocommerce-additional-fields">
                                        ...
                                        <p className="form-row form-row-wide">
                                            ...
                                            <textarea className="input-text" maxLength="250" rows="2" col="5" placeholder="Notes about your order, e.g. special notes for delivery." value={order_notes} onChange={(e) => { SetOrder_notes(e.target.value) }}></textarea>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {couponres ? <tr className="order-discount">
                                        ...
                                        <td>
                                            <strong>
                                                <span className="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        {coupontype == "fixed" ? <span className="woocommerce-Price-currencySymbol">$</span> : null}
                                                        {couponamount}
                                                        {coupontype == "percent" ? <span className="woocommerce-Price-currencySymbol">%</span> : null}
                                                        <br></br>
                                                    </bdi>
                                                </span>
                                            </strong>
