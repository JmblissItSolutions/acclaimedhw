                      ...
                      <div className="doc">
                        <a href="https://acclaimedhw.com/wp-content/uploads/2020/10/FullbrochureIDrealtor-AHW.pdf" className="venobox vbox-item" data-vbtype="iframe" data-gall="docs">
                           <i className="achi-pdf">
                            <img src={pdf} alt="pdf" className="pdf_img" />
                           </i>
                     ...
                     <div className="vid-cont">
                           ...
                           <div className="img-cont">
                              ...
                              <Modal visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
                                 <div className="content">
                                    <iframe  src="https://www.youtube.com/embed/1mzkbJSIMHc"></iframe>
                                 </div>
                              </Modal>
                        ...
                        <div className="video">
                           <div className="img-cont">
                              ...
                              <Modal visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
                                 <div className="content">
                                    <iframe src="https://www.youtube.com/embed/QsmndywTysA"></iframe>
                                 </div>
                              </Modal>
                        ...
                        <div className="video">
                           <div className="img-cont">
                              ...
                              <Modal visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
                                 <div className="content">
                                    <iframe src="https://youtube.com/embed/q7-GQn3-ZLs"></iframe>
                                 </div>
                              </Modal>
                        ...
                        <div className="video">
                           <div className="img-cont">
                              ...
                              <Modal visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
                              <div className="content">
                                 <iframe src="https://youtube.com/embed/iG5o3j7P7I4"></iframe>
                              </div>
                              </Modal>
